...
const JoinUs = () => {
  ...
  const sendFiles = () => {
    if (!cv) {
      ...
      fetch("http://45.80.153.150:5002/upcvs", {
        method: "POST",
        body: formdata,
      })
        .then((res) => res.text())
  ...
  const handleSubmit = (e) => {
    ...
    if (!nombre || !ap || !am || !email || !celular || !referencia) {
      ...
      axios
        .post("http://45.80.153.150:5002/joinusreg", {
          nombre,
          ap,
          am,
          email,
  ...
  return (
    <div className="container-fluid">
      <div className="parallax">
        ...
        <div className="container-fluid">
          <h2 className=" h22 ">Únete a nuestro equipo de asesores</h2>
          <div className="row">
                    ...
                    <div className=" col-sm-4">
                      ...
                      <div className=" ">
                        <input
                          type="file"
                          id="cvfile"
                          className="form-control-file inputformcv"
                          name="filecv"
                          multiple
                          onChange={CVHandler}
                        />
